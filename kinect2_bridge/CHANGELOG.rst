...
* Updated calibration for 002142565347
* Calibrated RGB for 002142565347
* Adding auto-restart feature to kinect2_bridge node.
* Added respawn to nodelet manager
* Calibrated RGB for 307004735147
* Checking first index of serial for int overflow workaround
* Adds a quality parameter to only launch the specified resolution nodelet.
...
* added capture signal pub
* added calibration for 002061565347
* restored calibration for 155954635247
* added calibration for 001530565347
* Adding output arg to kinect2_bridge.launch.
* Setting kinect2_bridge to Debug since it crashes otherwise.
* Added calibration for two Pilot Miso Kinect v2 sensors.
* Merge pull request `#352 <https://github.com/MisoRobotics/iai_kinect2/issues/352>`_ from Tobias-Fischer/master
  Add KDE depth unwrapping support
* Change help()
* Update README.md
* Add KDE support
* fixed PR
* Merge pull request `#343 <https://github.com/MisoRobotics/iai_kinect2/issues/343>`_ from MRASL/roslaunch_output
...
* Merge pull request `#215 <https://github.com/MisoRobotics/iai_kinect2/issues/215>`_ from delftrobotics/add-tf-depend
...
* Merge pull request `#48 <https://github.com/MisoRobotics/iai_kinect2/issues/48>`_ from airballking/master
...
* Merge pull request `#25 <https://github.com/MisoRobotics/iai_kinect2/issues/25>`_ from ibec-robotics/master
...
* Contributors: Andre Phu-Van Nguyen, Andrew Hundt, Georg Bartels, Jan-Hendrik Worch, Jordi, Kenta Yonekura, Lingzhu Xiang, Maarten de Vries, Peter KT Yu, Ryan Sinnet, Thiemo Wiedemeyer, Tobias Fischer, Will Werst, Zach Z-V, wkentaro
